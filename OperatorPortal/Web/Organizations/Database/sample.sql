...
INSERT INTO organizacje (
    ...
    OstatnieOdwiedzinyData
      ...
      (
          101, 1234567890123, 1234567890, 123456789, '0000123456', 'Stowarzyszenie', FALSE,
          'Stowarzyszenie Pomocy Społecznej "Nadzieja"', 'ul. Kwiatowa 15, 00-001 Warszawa',
          'Jadłodajnia "Nadzieja"', 'ul. Kwiatowa 15, 00-001 Warszawa', 'Śródmieście', 'Warszawa',
          'Stowarzyszenie Pomocy Społecznej "Nadzieja"', 'ul. Kwiatowa 15, 00-001 Warszawa',
          '+48 22 123 45 67', 'www.nadzieja.org', '+48 22 123 45 67', 'Jan Kowalski',
          'Jan Kowalski, +48 22 123 45 67', '+48 22 123 45 68', 'kontakt@nadzieja.org',
          'Pon-Pt 8:00-16:00', 'Anna Nowak', '+48 22 123 45 69', 'anna.nowak@nadzieja.org',
      ...
      (
          ...
          'Fundacja "Dobroczynność"', 'ul. Lipowa 7, 30-001 Kraków',
          'Świetlica "Dobroczynność"', 'ul. Lipowa 7, 30-001 Kraków', 'Stare Miasto', 'Kraków',
          'Fundacja "Dobroczynność"', 'ul. Lipowa 7, 30-001 Kraków', '+48 12 345 67 89',
          'www.dobroczynnosc.org', '+48 12 345 67 89', 'Piotr Nowak',
          'Piotr Nowak, +48 12 345 67 89', '+48 12 345 67 90', 'kontakt@dobroczynnosc.org',
          'Pon-Pt 9:00-17:00', 'Katarzyna Kowalska', '+48 12 345 67 91', 'katarzyna.kowalska@dobroczynnosc.org',
      ...
      (
          ...
          'Spółka "Zdrowie i Smak"', 'ul. Ogrodowa 22, 50-001 Wrocław',
          'Restauracja "Zdrowie i Smak"', 'ul. Ogrodowa 22, 50-001 Wrocław', 'Krzyki', 'Wrocław',
          'Spółka "Zdrowie i Smak"', 'ul. Ogrodowa 22, 50-001 Wrocław', '+48 71 234 56 78',
          'www.zdrowieismak.pl', '+48 71 234 56 78', 'Marek Zieliński',
          'Marek Zieliński, +48 71 234 56 78', '+48 71 234 56 79', 'kontakt@zdrowieismak.pl',
      ...
      (
          ...
          'Stowarzyszenie "Razem dla Dzieci"', 'ul. Słoneczna 5, 80-001 Gdańsk',
          'Przedszkole "Razem dla Dzieci"', 'ul. Słoneczna 5, 80-001 Gdańsk', 'Śródmieście', 'Gdańsk',
          'Stowarzyszenie "Razem dla Dzieci"', 'ul. Słoneczna 5, 80-001 Gdańsk', '+48 58 345 67 89',
          'www.razemdladzieci.org', '+48 58 345 67 89', 'Ewa Wiśniewska',
          'Ewa Wiśniewska, +48 58 345 67 89', '+48 58 345 67 90', 'kontakt@razemdladzieci.org',
      ...
      (
          ...
          'Fundacja "Pomocna Dłoń"', 'ul. Leśna 12, 90-001 Łódź',
          'Jadłodajnia "Pomocna Dłoń"', 'ul. Leśna 12, 90-001 Łódź', 'Widzew', 'Łódź',
          'Fundacja "Pomocna Dłoń"', 'ul. Leśna 12, 90-001 Łódź', '+48 42 123 45 67',
          'www.pomocnadlon.org', '+48 42 123 45 67', 'Krzysztof Nowak',
          'Krzysztof Nowak, +48 42 123 45 67', '+48 42 123 45 68', 'kontakt@pomocnadlon.org',
